...
class Tile{
  ...
  draw(x,y){
    this.handler.ctx.drawImage(this.sprite,this.xPositionInImage*this.width,this.yPositionInImage*this.width,this.width,this.height,x,y,this.width,this.height);
  }
}
